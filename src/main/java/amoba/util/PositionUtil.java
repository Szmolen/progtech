...
public final class PositionUtil {
    ...
    /**
     * Privát konstruktor – utility classt nem példányosítunk.
     */
     ...
     */
    public static Position fromAlgebraic(final String input) {
        if (input == null) {
        ...
        if (trimmed.length() < 2) {
            throw new IllegalArgumentException(
                    "Helytelen formátum - ('f5') " + input);
        }

        char colChar = trimmed.charAt(0);
        if (colChar < 'a' || colChar > 'z') {
            throw new IllegalArgumentException(
                    "Hibás oszlop - ('f5'): " + colChar);
        }
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Hibás szorszám, kérlek add meg helyesen! ('f5'): " + input,
                    e
            );
        }
     ...
     */
    public static String toAlgebraic(final Position pos) {
        if (pos == null) {
